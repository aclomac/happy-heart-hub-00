...
export const AUDIT_REGISTRY: AuditEntry[] = [
  ...
  { id: "dash-card-today-sales", module: M.home, label: "Dashboard: Today's Sales card click", kind: "button", route: "/app", status: W },
  { id: "dash-card-month-sales", module: M.home, label: "Dashboard: Month Sales card click", kind: "button", route: "/app", status: W },
  { id: "dash-card-other-income", module: M.home, label: "Dashboard: Month Other Income card click", kind: "button", route: "/app", status: W },
  { id: "dash-card-receivables", module: M.home, label: "Dashboard: Receivables card click", kind: "button", route: "/app", status: W },
  { id: "dash-card-payables", module: M.home, label: "Dashboard: Payables card click", kind: "button", route: "/app", status: W },
  { id: "dash-card-expenses", module: M.home, label: "Dashboard: Month Expenses card click", kind: "button", route: "/app", status: W },
  { id: "dash-card-low-stock", module: M.home, label: "Dashboard: Low Stock card click", kind: "button", route: "/app", status: W },
  { id: "dash-card-stock-value", module: M.home, label: "Dashboard: Stock Value card click", kind: "button", route: "/app", status: W },
  { id: "dash-card-total-items", module: M.home, label: "Dashboard: Total Items card click", kind: "button", route: "/app", status: W },
  { id: "dash-card-out-of-stock", module: M.home, label: "Dashboard: Out of Stock card click", kind: "button", route: "/app", status: W },
  { id: "dash-card-warehouses", module: M.home, label: "Dashboard: Warehouses card click", kind: "button", route: "/app", status: W },
  { id: "dash-card-transfers", module: M.home, label: "Dashboard: Recent Transfers card click", kind: "button", route: "/app", status: W },
  { id: "dash-low-stock-alerts", module: M.home, label: "Dashboard: Low Stock Alerts panel link", kind: "button", route: "/app", status: W },
 ...
 { id: "eco-live-wiz-woo", module: M.ecommerce, label: "WooCommerce Live Test Wizard opens", kind: "workflow", route: "/app/ecommerce/settings", status: W, note: "Wizard renders cred checks, connection test, product+order preview." },
 { id: "eco-live-wiz-woo-preview", module: M.ecommerce, label: "WooCommerce product/order preview fetch handles success/error", kind: "workflow", route: "/app/ecommerce/settings", status: W, note: "previewProducts / previewOrders return diagnostic errorKind; UI shows preview table or error message." },
 { id: "eco-live-wiz-sf", module: M.ecommerce, label: "Steadfast Live Test Wizard opens", kind: "workflow", route: "/app/ecommerce/settings", status: W, note: "Wizard renders cred checks, test connection, payload preview, explicit confirmation gate." },
 { id: "eco-live-wiz-sf-send", module: M.ecommerce, label: "Steadfast Send to Steadfast preview + confirm works", kind: "workflow", route: "/app/ecommerce/settings", status: W, note: "Payload shown before send; checkbox required; success persists consignmentId/trackingCode/trackingUrl." },
